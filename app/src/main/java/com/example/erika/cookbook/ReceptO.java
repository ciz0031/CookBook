...
public class ReceptO {
    ...
    public ReceptO(int ID_receptu, String nazev_receptu, String postup, int doba_pripravy, int doba_peceni, int stupne, String prilohy, int ID_kategorie, int ID_podkategorie, String foto, int pocet_porci){
